...
Alternatively to browse all the effects in the demo, first add all demo scenes to Build Settings before you start one of the scenes.

Make sure to also have the Post Processing package imported in your project to avoid errors on the Camera in each scene.
